...
9. Cltr+P or click "Play" to run the game to enter play mode then click on the "Export" button and wait until it is done.
...
11. (Optional) Run the "_magick_process.bat" batch file to convert some textures, and it is best to be done outside of UnityEditor to prevent it from importing back all the files you just exported and generateing all the .meta files you don't need.
